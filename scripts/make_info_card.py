...
# ===========================================================================
HOST = "Raza Serafim-Ioan"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Rol", "CS & Engineering Student @ UTCN"),
    ("kv", "Locatie", "Cluj-Napoca, Romania"),
    ("gap",),
    ("sec", "Tech Stack & Tools"),
    ("kv", "Limbaje", "C, Java, Assembly, MATLAB"),
    ("kv", "Date", "Copernicus Earth Observation"),
    ("gap",),
    ("sec", "Highlights & Proiecte"),
    ("bul", "CASSINI Hackathon 11th Edition"),
    ("bul", "FIERCE Project Momentum Cohort"),
]
